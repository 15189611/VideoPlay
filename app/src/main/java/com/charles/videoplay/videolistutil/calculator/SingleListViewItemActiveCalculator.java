...
import com.charles.videoplay.videolistutil.items.ListItemData;
import com.charles.videoplay.videolistutil.scroll_utils.ItemsPositionGetter;
...
public class SingleListViewItemActiveCalculator extends BaseItemsVisibilityCalculator {
    ...
    private static final int INACTIVE_LIST_ITEM_VISIBILITY_PERCENTS = 85;
